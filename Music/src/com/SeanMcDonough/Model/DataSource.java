package com.SeanMcDonough.Model;
...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Sean\\IdeaProjects\\Music\\" + DB_NAME;
...
//    ORDER BY artists.name, albums.name, songs.track;
    public static final String CREATE_ARTIST_FOR_SONG_VIEW =
                            "CREATE VIEW IF NOT EXISTS artist_list AS SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME +
...
//    SELECT name, album, track FROM artist_list WHERE title = "Go Your Own Way"
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        if(sortOrder != ORDER_BY_NONE) {
            System.out.println("!= order by none");
            sb.append(" ORDER BY ");
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder){
        ...
        sb.append("\"");
        sb.append(sortOrderCheck(QUERY_ALBUMS_BY_ARTIST_SORT, sortOrder));
    ...
    public List<SongArtist> queryArtistForSong(String songName, int sortOrder){
        ...
        sb.append(songName);
        sb.append("\"");
        sb.append(sortOrderCheck(QUERY_ARTIST_FOR_SONG_SORT, sortOrder));
    ...
    private static String sortOrderCheck(String statementSort, int sortOrder){
        StringBuilder sb = new StringBuilder();
        if(sortOrder != ORDER_BY_NONE){
            sb.append(statementSort);
            if(sortOrder == ORDER_BY_DESC){
                sb.append("DESC");
            } else {
                sb.append("ASC");
    ...
    public void querySongsMetadata(){
        ...
        try (Statement statement = conn.createStatement();
            ...
            for(int i=1; i<= numColumns; i++){
                System.out.format("Column %d in the song table is named %s\n",
